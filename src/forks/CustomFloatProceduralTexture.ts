...
export class CustomFloatProceduralTexture extends ProceduralTexture {
  ...
  private _loadJson(jsonUrl: string): void {
    const noConfigFile = () => {
      try {
        ...
        Logger.Error(
          "No json or ShaderStore or DOM element found for CustomFloatProceduralTexture"
        );
      }
    };
  ...
  public readPixels(): Nullable<Promise<ArrayBufferView>> {
